...
{
    public static AsyncOperationHandle<string> LoadBeatmap(string filePath)
    {
        ...
        Func<AsyncOperationHandle<DefaultAsset>, AsyncOperationHandle<string>> chainFunc = (AsyncOperationHandle<DefaultAsset> op) =>
        {
        ...
        AsyncOperationHandle<string> chainHandle =
            Addressables.ResourceManager.CreateChainOperation<string, DefaultAsset>(assetOp, chainFunc, false);
