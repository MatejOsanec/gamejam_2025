...
[CustomPropertyDrawer(typeof(SignalSenderAttribute))]
public class SignalSenderDrawer : PropertyDrawer {

    // Draw the property inside the given rect
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {

        //var eventSenderAttribute = attribute as EventSenderAttribute;            
        var gameEvent = property.objectReferenceValue as Signal;
        ...
        if (gameEvent == null) {
            ...
            if (GUI.Button(buttonRect, "create")) {
                ...
                var asset = ScriptableObjectEditorExtensions.CreateScriptableObjectInSelectedProjectFolder(
                    field.FieldType,
                    targetObjectClassType.Name + "." + ObjectNames.NicifyVariableName(field.Name).Replace(" ", "")
                        .Replace("Signal", "")
                );
