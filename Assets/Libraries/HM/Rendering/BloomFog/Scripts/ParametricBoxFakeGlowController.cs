...
public class ParametricBoxFakeGlowController : MonoBehaviour {
    ...
    public float edgeSizeMultiplier = 4.0f;
    public Color color;

    public Vector3 localPosition { set => transform.localPosition = value; }
    ...
    public void Refresh() {
        ...
        var v = new Vector4(width * 0.5f, height * 0.5f, length * 0.5f, edgeSize * 0.5f * edgeSizeMultiplier);
