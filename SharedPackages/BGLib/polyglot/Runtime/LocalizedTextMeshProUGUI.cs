namespace BGLib.Polyglot {
    ...
    public class LocalizedTextMeshProUGUI : LocalizedTextComponent<TextMeshProUGUI> {
        ...
        private static bool IsAlignmentRight(TextAlignmentOptions alignment) {
            ...
            return alignment is TextAlignmentOptions.BottomRight or TextAlignmentOptions.Right or TextAlignmentOptions.TopRight;
        }

        private static bool IsAlignmentLeft(TextAlignmentOptions alignment) {
            
            return alignment is TextAlignmentOptions.BottomLeft or TextAlignmentOptions.Left or TextAlignmentOptions.TopLeft;
        }
        ...
        private void OnValidate() {
            ...
            if (localizedComponent == null) {
                localizedComponent = GetComponent<TextMeshProUGUI>();
            }
        }
#endif
    }
